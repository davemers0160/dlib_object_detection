...
using net_type = dlib::loss_mmod<con9<1,
    ...
    dlib::relu<dlib::bn_con<con5<128,
    dlib::relu<dlib::bn_con<con5<64,
    dlib::relu<dlib::bn_con<con5<64,

    dlib::relu<dlib::bn_con<con5d<64, dlib::relu<dlib::bn_con<con5d<32, dlib::relu<dlib::bn_con<con5d<16, 
    
    dlib::input_array_image_pyramid<dlib::pyramid_down<pyramid_size>, array_depth>
    >>>>>>>>> >>> >>> >>> >>;

using anet_type = dlib::loss_mmod<con9<1,

    dlib::relu<dlib::affine<con5<128,
    dlib::relu<dlib::affine<con5<64,
    dlib::relu<dlib::affine<con5<64,

    dlib::relu<dlib::affine<con5d<64, dlib::relu<dlib::affine<con5d<32, dlib::relu<dlib::affine<con5d<16, 
